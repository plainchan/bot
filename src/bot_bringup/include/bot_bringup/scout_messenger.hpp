...
#include "bot_msgs/ScoutStatus.h"
#include "bot_msgs/ScoutLightCmd.h"
...
class ScoutMessenger {
 public:
  ...
  void SetupSubscription() {
    ...
    light_cmd_sub_ = nh_->subscribe<bot_msgs::ScoutLightCmd>(
 ...
 private:
  ...
  void LightCmdCallback(const bot_msgs::ScoutLightCmd::ConstPtr &msg) {
    if (!simulated_robot_) {
      if (msg->cmd_ctrl_allowed) {
        ...
        switch (msg->front_mode) {
          case bot_msgs::ScoutLightCmd::LIGHT_CONST_OFF: {
            f_mode = AgxLightMode::CONST_OFF;
            break;
          }
          case bot_msgs::ScoutLightCmd::LIGHT_CONST_ON: {
            f_mode = AgxLightMode::CONST_ON;
            break;
          }
          case bot_msgs::ScoutLightCmd::LIGHT_BREATH: {
            f_mode = AgxLightMode::BREATH;
            break;
          }
          case bot_msgs::ScoutLightCmd::LIGHT_CUSTOM: {
  ...
  void PublishStateToROS() {
    ...
    bot_msgs::ScoutStatus status_msg;
