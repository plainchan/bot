...
#include <bot_imu/Imu_0x91_msg.h>
#include <bot_imu/Imu_0x62_msg.h>
#include <bot_imu/Imu_data_package.h>
#include <signal.h>
...
void publish_0x91_data(raw_t *data, bot_imu::Imu_0x91_msg *data_imu);
void publish_imu_data(raw_t *data, sensor_msgs::Imu *imu_data);
void publish_0x62_data(raw_t *data, bot_imu::Imu_0x62_msg *data_imu);
...
{
	int rev = 0;
	ros::init(argc, argv, "bot_imu");
	ros::NodeHandle n;

	ros::Publisher IMU_pub = n.advertise<sensor_msgs::Imu>("data", 20);
	ros::Publisher Imu_0x91_pub = n.advertise<bot_imu::Imu_0x91_msg>("/imu_0x91_package", 10);
	ros::Publisher Imu_0x62_pub = n.advertise<bot_imu::Imu_0x62_msg>("/imu_0x62_package", 10);
	...
	bot_imu::Imu_0x91_msg imu_0x91_msg;
	bot_imu::Imu_0x62_msg imu_0x62_msg;
...
void imu_data_package(raw_t *data, bot_imu::Imu_data_package *data_imu, int num)
{
